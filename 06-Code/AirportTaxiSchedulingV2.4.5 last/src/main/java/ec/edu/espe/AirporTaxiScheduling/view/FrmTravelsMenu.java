 ...
 */
public class FrmTravelsMenu extends javax.swing.JFrame {

    /**
     * Creates new form formTravelsMenu
     */
    public FrmTravelsMenu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTravelsMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTravelsMenu().setVisible(true);
            }
        });
    }

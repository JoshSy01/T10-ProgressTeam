...
public class FrmTarif extends javax.swing.JFrame {
                                                                      ...
                                                                      .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                ...
                                                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                                                          ...
                                                                                          .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                                                                    .addComponent(txtExitAdress, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                                                                                                    .addComponent(txtArrivalAdress, javax.swing.GroupLayout.Alignment.LEADING)
                                                                                                    .addComponent(txtKilometre, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                    .addComponent(tarifd, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                                                  .addGroup(jPanel1Layout.createSequentialGroup()
                                                            .addGap(32, 32, 32)
                    ...
                    jPanel1Layout.setVerticalGroup(
                              ...
                              .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                  .addComponent(jLabel5)
                                                  .addComponent(lblValue)
                                                  .addComponent(tarifd, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(18, 18, 18)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                  .addComponent(btnAccept)
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
              if (txtExitAdress.getText().isEmpty() || txtExitAdress.getText().isEmpty() || txtKilometre.getText().isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Complete los campos vacios para continuar");
              } else {
                        Tarif tarif = new Tarif();
                        DecimalFormat df = new DecimalFormat("#.##");
                        TarifSingleton tarifS = TarifSingleton.getInstance();
                        tarifS.modifyTax(0.40F);
                        tarifd.setText(df.format(tarifS.getTarifValue()));
